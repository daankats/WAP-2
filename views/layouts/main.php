        ...
        <div class="row">
            <div class="col-auto custom-menu col-md-3 col-xl-2 px-0 min-vh-100">
                ...
                <ul class="nav nav-pills flex-column mb-auto custom-nav-links">
                    <li class="nav-item">
                        <a href="/" class="nav-link <?php echo ($currentUrl == '/') ? 'active' : ''; ?>" aria-current="page">
                            Home
                        </a>
                    </li>
                    <?php if (Auth::isGuest()) : ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($currentUrl == '/login') ? 'active' : ''; ?>" aria-current="page" href="/login">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($currentUrl == '/register') ? 'active' : ''; ?>" aria-current="page" href="/register">Register</a>
                        </li>
                    <?php else : ?>
