...
$app->router->post('/courses/create', [CourseController::class, 'store'], AuthMiddleware::class);
...
$app->router->post('/courses/update', [CourseController::class, 'update'], AuthMiddleware::class);
...
$app->router->post('/exams/create', [ExamsController::class, 'store'], AuthMiddleware::class);
...
$app->router->post('/exams/registerexam', [ExamsController::class, 'storeRegisteredExam'], AuthMiddleware::class);
$app->router->get('/exams/unregisterexam', [ExamsController::class, 'unregisterExam'], AuthMiddleware::class);
$app->router->post('/exams/unregisterexam', [ExamsController::class, 'storeUnregisteredExam'], AuthMiddleware::class);
$app->router->get('/exams/addgrades', [ExamsController::class, 'addGrades'], AuthMiddleware::class);
$app->router->post('/exams/addgrades', [ExamsController::class, 'storeGrades'], AuthMiddleware::class);
$app->router->get('/exams/updategrade', [ExamsController::class, 'updateGrade'], AuthMiddleware::class);
$app->router->post('/exams/updategrade', [ExamsController::class, 'storeUpdatedGrade'], AuthMiddleware::class);
